...
class PMD:
    ...
    def similarity_names(self, name1, name2, threshold=0.69):
    ...
    def similarity_street(self, str1, str2, threshold=0.69):
    ...
    def similarity_state(self, str1, str2, threshold=0.69):
